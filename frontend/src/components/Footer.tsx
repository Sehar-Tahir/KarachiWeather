  ...
  return (
    <footer className="border-t border-white/5 mt-10 relative z-10 footer">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={l}>
                  <Link
                    to={p}
                    className="text-xs text-white hover:text-sky-400 transition-colors"
                  >
                    {l}
                  </Link>
                </li>
      ...
      hover:text-sky-400 hover:border-sky-400/30 transition-all"
              ...
              <a
                href="mailto:officialkarachiweather@gmail.com"
                className="w-8 h-8 flex items-center justify-center rounded-lg
      bg-white/5 border border-white/10 text-white
      hover:text-sky-400 hover:border-sky-400/30 transition-all"
                title="Email Us"
            ...
            <p className="text-xs text-white leading-relaxed foot">
              Real-time weather intelligence for Karachi & the world. Live
              temperature, forecasts, air quality and more.
            </p>
          </div>
        </div>
